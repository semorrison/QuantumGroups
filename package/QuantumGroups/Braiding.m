...
\!\(LoadBraidingData[\[CapitalGamma]_\_n_] := Module[{}, \[IndentingNewLine]Off[Get::noopen, Needs::nocont]; \[IndentingNewLine]Needs["\<QuantumGroups`Data`\>" <> ToString[\[CapitalGamma]] <> ToString[n] <> "\<`BraidingData`\>"]; \[IndentingNewLine]On[Get::noopen, Needs::nocont]; \[IndentingNewLine]LoadBraidingData[\[CapitalGamma]\_n] = False; \[IndentingNewLine]True\[IndentingNewLine]]\)
